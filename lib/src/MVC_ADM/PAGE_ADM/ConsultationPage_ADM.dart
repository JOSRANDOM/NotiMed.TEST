...
class InterconsultaADM extends StatefulWidget {
  const InterconsultaADM({Key? key}) : super(key: key);

  @override
  State<InterconsultaADM> createState() => _HomeState();
}

class _HomeState extends State<InterconsultaADM> {
  @override
  void initState() {
    super.initState();
...
Future<String?> _loadLoginData() async {
  ...
  Future<List<Paciente>> _postPaciente(BuildContext context) async {
    const url = 'https://notimed.sanpablo.com.pe:8443/api/clinic/interconsultings';
